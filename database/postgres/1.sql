...
COPY restaurants ( name_of_restaurant, number_of_reviews, rating_overall, rating_recent, rating_food ,rating_service , rating_ambience , noise_level, would_recommend , percent_five_star , percent_four_star , percent_three_star , percent_two_star , percent_one_star ,loved_for, filters) FROM '/home/ubuntu/restaurnt.csv' CSV HEADER;

COPY users ( avatar , first_name,  last_name, number_of_reviews ,locale) FROM '/home/ubuntu/users.csv' CSV HEADER;